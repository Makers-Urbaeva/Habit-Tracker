...
values (1, 'Running', 'Running every day', 3, 'DAILY', '2023-05-01', '2023-05-01'),
       (2, 'Reading', 'Reading every month', 3, 'MONTHLY', '2023-05-01', '2023-05-01'),
       (3, 'Learning', 'Learning every week', 3, 'WEEKLY', '2023-05-01', '2023-05-01'),
       (4, 'YOGA', 'YOGA every day', 3, 'DAILY', '2023-05-01', '2023-05-01');
